 ...
 */
static const uint32 leftkey_swap[16] = {
...
static const uint32 rightkey_swap[16] = {
 ...
 *    subkey:       Array of at least 32 uint32s. Will be filled
 *                  with calculated subkeys.
 *
 */
static void des_key_schedule (const unsigned char * _rawkey, uint32 * subkey)
{
...
int gl_des_makekey (gl_des_ctx *ctx, const unsigned char * key, int keylen)
{
  if (keylen != 8)
    return 0;
...
void gl_des_ecb_crypt (gl_des_ctx *ctx, const unsigned char * _from, unsigned char * _to, int mode)
{
...
void gl_3des_set2keys (gl_3des_ctx *ctx, const unsigned char * key1, const unsigned char * key2)
{
  int i;
...
void gl_3des_set3keys (gl_3des_ctx *ctx, const unsigned char * key1,
